pipeline {
    ...
    stages {
        ...
        stage('Docker Deploy') {
            ...
            docker container run --restart always --name api-gateway-webservice -p 9000:9000 -d api-gateway-webservice && docker network connect foodie-inc-network api-gateway-webservice
            '''
            }
        }
    }
